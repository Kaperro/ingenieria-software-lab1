...
public class ClientController {
    ...
    public Client updateNit(@PathVariable long id, @PathVariable String nit) {
        ...
        client.setNit(nit);
        return this._clientService.editarCliente(client);
    }
    ...
    public String generateReport() {
        return this._reportService.generateReport(this._clientService.buscarTodos(), _servletContext);
    }
}
